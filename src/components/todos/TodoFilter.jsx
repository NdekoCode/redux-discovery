  ...
  return (
    <div>
      <button
        ...
        className="px-2 py-2.5 bg-blue-600 rounded-md m-1 text-white"
      >
        Aucun filtre
      </button>
      <button
        ...
        className="px-2 py-2.5 bg-green-600 text-white rounded-md m-1"
      >
        Completer
      </button>
      ...
      <button
        ...
        className="px-2 py-2.5 bg-red-600 text-white rounded-md m-1"
      >
        A faire{" "}
      </button>
    </div>
