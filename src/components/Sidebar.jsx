      ...
      <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        <ul className="space-y-2">
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Counter</span>
            </NavLink>
          </li>
        ...
        >
          <div className="flex items-center mb-3">
            <span className="bg-orange-100 text-green-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900">
              Redux Discovery
            </span>
            <button
              type="button"
          ...
          <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
            Pour utiliser redux avec react il va falloir le faire grâce à un
            provider, donc il va falloir créer un provider qui va englober notre
            application et pour cela on utilise react-redux.
          </p>
          <a
            className="text-sm text-blue-900 underline hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
            href="#"
          >
            Discover redux and its different features
          </a>
        </div>
      </div>
    </aside>
